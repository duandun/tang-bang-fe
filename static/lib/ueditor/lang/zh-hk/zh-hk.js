...
UE.I18N['zh-hk'] = {
    'labelMap':{
        ...
        'justifyjustify':'兩端對齊', 'forecolor':'字體顔色', 'backcolor':'背景色', 'insertorderedlist':'有序列表',
    ...
    'insertimage':{
        ...
        'errorNotSupport': 'WebUploader 不支持您的浏覽器！如果你使用的是IE浏覽器，請嘗試升級 flash 播放器。',
        'errorLoadConfig': '後端配置項沒有正常加載，上傳插件不能正常使用！',
    ...
    'help':{
        'static':{
            ...
            'lang_input_introduction':'UEditor是由百度web前端研發部開發的所見即所得富文本web編輯器，具有輕量，可定制，注重用戶體驗等特點。開源基于BSD協議，允許自由使用和修改代碼。',
            'lang_Txt_shortcuts':'快捷鍵',
            'lang_Txt_func':'功能',
            'lang_Txt_bold':'給選中字設置爲加粗',
            'lang_Txt_copy':'複制選中內容',
            'lang_Txt_cut':'剪切選中內容',
            'lang_Txt_Paste':'粘貼',
            'lang_Txt_undo':'重新執行上次操作',
            'lang_Txt_redo':'撤銷上一次操作',
            'lang_Txt_italic':'給選中字設置爲斜體',
    ...
    'link':{
        ...
        'httpPrompt':'您輸入的超鏈接中不包含http等協議名稱，默認將爲您添加http://前綴'
    },
    'map':{
        'static':{
            lang_city:"城市",
    ...
    'searchreplace':{
        'static':{
            ...
            lang_search2:"查找",
            lang_replace:"替換",
            lang_searchReg:'支持正則表達式，添加前後斜杠標示爲正則表達式，例如“/表達式/”',
            lang_searchReg1:'支持正則表達式，添加前後斜杠標示爲正則表達式，例如“/表達式/”',
    ...
    'snapscreen':{
        'static':{
            ...
            lang_step2:"第二步，插件安裝完成後即可使用，如不生效，請重啓浏覽器後再試！"
        }
    },
    'spechars':{
        'static':{},
